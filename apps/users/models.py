...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    def get_ai_hint_limit(self):
        ...
        return settings.AI_HINTS_PRO_DAILY if self.is_pro else settings.AI_HINTS_FREE_DAILY

    def get_ai_chat_limit(self):
        from django.conf import settings
        return settings.AI_CHAT_PRO_DAILY if self.is_pro else settings.AI_CHAT_FREE_DAILY
