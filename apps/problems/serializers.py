...
class SolutionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Solution
        fields = [
            "id", "title", "approach_summary_md",
            "code_python", "code_cpp", "code_java", "code_javascript",
            "time_complexity", "space_complexity", "complexity_explanation_md",
            "is_official", "visibility", "order_index", "is_locked",
        ]
...
class ProblemListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Problem
        fields = [
            "id", "slug", "title", "number", "difficulty", "visibility",
            "section", "tags", "acceptance_rate",
            "time_complexity_average", "space_complexity",
            "total_submissions", "accepted_submissions", "is_solved",
        ]
...
class ProblemDetailSerializer(serializers.ModelSerializer):
    ...
    def get_hints(self, obj):
        ...
        return [{"index": i, "available": True, "content": h} for i, h in enumerate(hints)]
...
class ProblemAdminSerializer(serializers.ModelSerializer):
    ...
    section_id = serializers.PrimaryKeyRelatedField(
        queryset=Section.objects.all(), source="section", write_only=True, required=False
    )
    ...
    class Meta:
        ...
        fields = [
            "id", "slug", "title", "number", "difficulty", "visibility",
            "statement_md", "section", "section_id", "tags", "tag_ids",
            "time_complexity_best", "time_complexity_average", "time_complexity_worst",
            "space_complexity", "complexity_notes_md", "hints_md",
